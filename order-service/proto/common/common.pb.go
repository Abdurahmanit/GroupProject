...
func (x *AddressProto) GetPostalCode() string {
	if x != nil {
		return x.PostalCode
	}
	return ""
...
func (x *AddressProto) GetCountry() string {
	if x != nil {
		return x.Country
	}
	return ""
...
type StandardErrorProto struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
...
func (x *StandardErrorProto) Reset() {
	*x = StandardErrorProto{}
	mi := &file_common_proto_msgTypes[3]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *StandardErrorProto) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*StandardErrorProto) ProtoMessage() {}

func (x *StandardErrorProto) ProtoReflect() protoreflect.Message {
	mi := &file_common_proto_msgTypes[3]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use StandardErrorProto.ProtoReflect.Descriptor instead.
func (*StandardErrorProto) Descriptor() ([]byte, []int) {
	return file_common_proto_rawDescGZIP(), []int{3}
}

func (x *StandardErrorProto) GetCode() int32 {
	if x != nil {
		return x.Code
	}
	return 0
...
func (x *StandardErrorProto) GetMessage() string {
	if x != nil {
		return x.Message
	}
	return ""
...
const file_common_proto_rawDesc = "" +
	"\n" +
	"\fcommon.proto\x12\x06common\x1a\x1fgoogle/protobuf/timestamp.proto\x1a\x1bgoogle/protobuf/empty.proto\"u\n" +
	"\fAddressProto\x12\x16\n" +
	...
	"totalPages\"B\n" +
	"\x12StandardErrorProto\x12\x12\n" +
	"\x04code\x18\x01 \x01(\x05R\x04code\x12\x18\n" +
	"\amessage\x18\x02 \x01(\tR\amessageBJZHgithub.com/Abdurahmanit/GroupProject/order-service/proto/common;commonpbb\x06proto3"
